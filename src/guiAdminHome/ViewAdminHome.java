...
public class ViewAdminHome {
	...
	*/
	...
	private ViewAdminHome() {
	    ...
	    deleteAlert.setTitle("You cannot delete your own account.");
	    deleteAlert.setHeaderText("You cannot delete your own account.");
	    deleteAlert.setContentText("Another admin must delete it for you");
...
//	public static DialogPane userListDisplay = null;
	...
	public static void showDeleteAlert() {
	    ...
	    ViewAdminHome.ChoiceDialog_UserOTP.showAndWait();
	}
