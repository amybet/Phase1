...
public class ViewUserUpdate {
	...
	private ViewUserUpdate() {
		...
		theUserUpdateScene.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());
		...
		attachInlineValidator(
				dialogUpdatePassword,
			    name -> InputRecognizer.checkPassword(name)
			);
		...
		attachInlineValidator(
			    ...
			    name -> InputRecognizer.checkName(name)
			);
		...
		attachInlineValidator(
				dialogUpdatePreferredFirstName,
			    name -> InputRecognizer.checkName(name)
			);
		...
		attachInlineValidator(
			    dialogUpdateEmailAddresss,
			    email -> InputRecognizer.checkEmailAddress(email)
			);

		DialogPane dialogUpdatePasswordPane = dialogUpdatePassword.getDialogPane();
		dialogUpdatePasswordPane.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());
		dialogUpdatePasswordPane.getStyleClass().add("alertStyle");
		
		DialogPane dialogUpdateFirstNamePane = dialogUpdateFirstName.getDialogPane();
		dialogUpdateFirstNamePane.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());
		dialogUpdateFirstNamePane.getStyleClass().add("alertStyle");
		
		DialogPane dialogUpdateLastNamePane = dialogUpdateLastName.getDialogPane();
		dialogUpdateLastNamePane.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());
		dialogUpdateLastNamePane.getStyleClass().add("alertStyle");
		
		DialogPane dialogUpdateMiddleNamePane = dialogUpdateMiddleName.getDialogPane();
		dialogUpdateMiddleNamePane.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());
		dialogUpdateMiddleNamePane.getStyleClass().add("alertStyle");
		
		DialogPane dialogUpdatePreferredFirstNamePane = dialogUpdatePreferredFirstName.getDialogPane();
		dialogUpdatePreferredFirstNamePane.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());
		dialogUpdatePreferredFirstNamePane.getStyleClass().add("alertStyle");
		
		DialogPane dialogUpdateEmailAddresssPane = dialogUpdateEmailAddresss.getDialogPane();
		dialogUpdateEmailAddresssPane.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());
		dialogUpdateEmailAddresssPane.getStyleClass().add("alertStyle");
        ...
        button_UpdatePassword.setOnAction((_) -> {
        	dialogUpdatePassword.getEditor().setText("");
	    	...
	    	else label_CurrentPassword.setText(newPass);
	     	});
        ...
        button_UpdateFirstName.setOnAction((_) -> {
        	dialogUpdateFirstName.getEditor().setText("");
        ...
        button_UpdateMiddleName.setOnAction((_) -> {
        	dialogUpdateMiddleName.getEditor().setText("");
        ...
        button_UpdateLastName.setOnAction((_) -> {
        	dialogUpdateLastName.getEditor().setText("");
        ...
        button_UpdatePreferredFirstName.setOnAction((_) -> 
        	{
        	dialogUpdatePreferredFirstName.getEditor().setText("");
        ...
        button_UpdateEmailAddress.setOnAction((_) -> {
        	dialogUpdateEmailAddresss.getEditor().setText("");
...
;        
	...
	/**********
	 * <p> Method: attachInlineValidator() </p>
	 * 
	 * <p> Description: This method attaches a validator to a buttons "ok" press, and sets up a visible error code label. </p>
	 *  @param input		The Dialog Box, and the function that will call the validator
	 * </p>
	 * 
	 */
	private void attachInlineValidator(
	        TextInputDialog dialog,
	        Function<String, String> validator) {

	    Label errorLabel = new Label();
	    errorLabel.setStyle("-fx-text-fill: red; -fx-font-size: 8px; -fx-padding: 3 0 0 0;");
	    errorLabel.setVisible(false);

	    DialogPane pane = dialog.getDialogPane();
	    GridPane grid = (GridPane) pane.getContent();
	    grid.add(errorLabel, 1, 2); //fart
