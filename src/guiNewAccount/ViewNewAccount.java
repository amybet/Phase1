...
public class ViewNewAccount {
	...
	*/
	...
	protected static Alert alertInvalidPasswordError = new Alert(AlertType.INFORMATION);
	...
	*/
	...
	private ViewNewAccount() {
		...
		theNewAccountScene.getStylesheets().add(getClass().getResource("/applicationMain/application.css").toExternalForm());
		...
		alertInvalidPasswordError.setTitle("Password is invalid");
		alertInvalidPasswordError.setHeaderText("");
		alertInvalidPasswordError.setContentText("Correct the password and try again.");
		
		alertInvalidUsernameError.setTitle("Username is invalid");
		alertInvalidUsernameError.setHeaderText("");
		alertInvalidUsernameError.setContentText("Correct the username and try again.");
