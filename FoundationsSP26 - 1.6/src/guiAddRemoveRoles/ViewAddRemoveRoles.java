...
public class ViewAddRemoveRoles {
	...
	*/
	 ...
	 * the AddRemoveRoles page to be displayed.
	 * 
	...
	public ViewAddRemoveRoles() {
		...
		// Due to the very dynamic nature of this page, setting the widgets into the Root Pane has 
		// been delegated to the repaintTheWindow and doSelectUser controller methods.
