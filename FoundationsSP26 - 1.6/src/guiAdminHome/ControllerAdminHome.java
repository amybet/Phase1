 ...
 * @version 1.02		2026-02-09 Implement remaining admin functions
 */
...
public class ControllerAdminHome {
	...
	*/
	...
	protected static void manageInvitations () {
		...
		confirmDialog.setTitle("Confirm invite deletion");


		confirmDialog.setContentText("Are you sure you'd like to delete this InviteCode?");

		

		// Change button text from Ok/Cancel to Yes/No
	...
	protected static void deleteUser() {
		...
		String selectedUsername = result.get();
		...
		confirmDialog.setHeaderText("Are you sure you want to permanently delete " + 
		...
		if (confirmation.isPresent() && confirmation.get() == ButtonType.YES) {
			...
			//ViewAdminHome.deleteChoiceDialog.getItems().clear();
	...
	private static void showDeleteAlert(String string, String string2, AlertType error) {
